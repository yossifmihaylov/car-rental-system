namespace CarRentalSystem.Domain.Common
{
    ...
    public class Enumeration : IComparable
    {
        ...
        {
            if (!(otherObj is Enumeration otherValue))
            {
                return false;
            }

            var typeMatches = this.GetType() == otherObj.GetType();
        ...
        public int CompareTo(object? otherObj) => this.Value.CompareTo(((Enumeration)otherObj!).Value);
    }
}
